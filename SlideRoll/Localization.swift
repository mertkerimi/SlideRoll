...
struct Strings {
    ...
    var allowPhotosDeniedReason: String { L(["Photo access is required to use SlideRoll. Please enable it in Settings.","SlideRoll'u kullanmak için fotoğraf erişimine izin vermeniz gerekiyor. Lütfen Ayarlar'dan etkinleştirin.","Se necesita acceso a las fotos para usar SlideRoll. Actívalo en Ajustes.","L'accès aux photos est requis pour utiliser SlideRoll. Activez-le dans Réglages.","È necessario l'accesso alle foto per usare SlideRoll. Abilitalo nelle Impostazioni.","O acesso às fotos é necessário para usar o SlideRoll. Ative nas Ajustes.","Für SlideRoll ist der Zugriff auf Fotos erforderlich. Aktiviere ihn in den Einstellungen.","SlideRollを使用するには写真へのアクセスが必要です。設定で有効にしてください。","SlideRoll을 사용하려면 사진 접근이 필요합니다. 설정에서 활성화해 주세요.","使用SlideRoll需要照片访问权限。请在设置中启用。","مطلوب الوصول إلى الصور لاستخدام SlideRoll. يُرجى تفعيله من الإعدادات.","Для использования SlideRoll необходим доступ к фото. Включите его в Настройках."]) }
