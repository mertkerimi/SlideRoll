...
struct Strings {
    ...
    var ob1Title: String { L(["Welcome to Swype","Swype'a Hoş Geldin","Bienvenido a Swype","Bienvenue sur Swype","Benvenuto su Swype","Bem-vindo ao Swype","Willkommen bei Swype","Swypeへようこそ","Swype에 오신 것을 환영합니다","欢迎使用 Swype","مرحبًا بك في Swype","Добро пожаловать в Swype"]) }
