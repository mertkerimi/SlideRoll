...
final class NotificationManager {
    ...
    private func messages(_ l: AppLanguage) -> [(String, String)] {
        ...
        case .turkish: return [
            ...
            ("Temizlik vakti geldi 🧹", "Kaydettiklerinin kaçını gerçekten saklıyorsun? PhotoMint ile öğren."),
            ...
            ("Hatırlatıcı 🔔", "PhotoMint ile galerine bir göz atmayı unutma.")
        ]
        case .english: return [
            ...
            ("Time for a cleanup 🧹", "How many of those shots are you actually keeping? Find out with PhotoMint."),
            ...
            ("Quick reminder 🔔", "Don't forget to check your gallery with PhotoMint today.")
        ]
        case .german: return [
            ...
            ("Zeit zum Aufräumen 🧹", "Wie viele Aufnahmen behältst du wirklich? Finde es mit PhotoMint heraus."),
            ...
            ("Kurze Erinnerung 🔔", "Vergiss nicht, heute deine Galerie mit PhotoMint zu prüfen.")
        ]
        case .spanish: return [
            ...
            ("Hora de limpiar 🧹", "¿Cuántas de esas fotos guardas de verdad? Descúbrelo con PhotoMint."),
            ...
            ("Recordatorio 🔔", "No olvides revisar tu galería con PhotoMint hoy.")
        ]
        case .french: return [
            ...
            ("L'heure du tri 🧹", "Combien de ces photos gardez-vous vraiment ? Découvrez-le avec PhotoMint."),
            ...
            ("Petit rappel 🔔", "N'oubliez pas de vérifier votre galerie avec PhotoMint aujourd'hui.")
        ]
        case .italian: return [
            ...
            ("È ora di fare ordine 🧹", "Quante di quelle foto tieni davvero? Scoprilo con PhotoMint."),
            ...
            ("Promemoria 🔔", "Non dimenticare di controllare la galleria con PhotoMint oggi.")
        ]
        case .portuguese: return [
            ...
            ("Hora da limpeza 🧹", "Quantas dessas fotos você realmente guarda? Descubra com o PhotoMint."),
            ...
            ("Lembrete 🔔", "Não esqueça de revisar sua galeria com o PhotoMint hoje.")
        ]
        case .japanese: return [
            ("ギャラリーが待っています 📸", "写真がたまってきました。2分でお片付けできます。"),
            ("ストレージがいっぱいになる前に…", "しばらくギャラリーを見ていませんね。さっと確認しませんか？"),
            ("お片付けの時間です 🧹", "その写真、本当に何枚残しますか？PhotoMintで確認しましょう。"),
            ...
            ("リマインダー 🔔", "今日もPhotoMintでギャラリーを確認するのをお忘れなく。")
        ]
        case .korean: return [
            ("갤러리가 기다리고 있어요 📸", "사진이 쌓였어요. 2분이면 정리할 수 있어요."),
            ("저장 공간이 차기 전에…", "한동안 갤러리를 안 보셨네요. 빠르게 살펴볼까요?"),
            ("정리할 시간이에요 🧹", "그 사진들 중 몇 장이나 정말 보관하나요? PhotoMint로 확인해 보세요."),
            ...
            ("알림 🔔", "오늘 PhotoMint로 갤러리 확인하는 것 잊지 마세요.")
        ]
        case .chinese: return [
            ("你的图库在等你 📸", "照片越积越多了。2 分钟就能清理好。"),
            ("在存储占满之前…", "你有一阵子没看图库了。要不要快速看一眼？"),
            ("该清理一下了 🧹", "那些照片你真正会留几张？用 PhotoMint 来看看。"),
        ...
        case .arabic: return [
            ...
            ("تذكير 🔔", "لا تنسَ تفقّد معرضك مع PhotoMint اليوم.")
        ]
        case .russian: return [
            ...
            ("Время навести порядок 🧹", "Сколько из этих снимков вы правда храните? Узнайте со PhotoMint."),
            ...
            ("Напоминание 🔔", "Не забудьте сегодня проверить галерею со PhotoMint.")
        ]
        }
    }
}
